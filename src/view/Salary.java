...
public class Salary extends javax.swing.JPanel {
    ...
    public Salary() {
        ...
        table_employee_salary.setModel(departementTableModel);
        loadData();
    }
    ...
    private void initComponents() {
        ...
        position_label2 = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        table_employee_salary = new javax.swing.JTable();
        ...
        header_new_position.setText("New Employee Salary");

        line_icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/pipe.png"))); // NOI18N

        position_fields.setActionCommand("<Not Set>");
        position_fields.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        ...
        position_label1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        position_label1.setText("Employee Name");

        position_label2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        position_label2.setText("Rp.");
        ...
        add_dialog_panelLayout.setHorizontalGroup(
            ...
            .addGroup(add_dialog_panelLayout.createSequentialGroup()
                ...
                .addComponent(header_new_position, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(add_dialog_panelLayout.createSequentialGroup()
                .addGap(14, 14, 14)
                .addGroup(add_dialog_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(add_dialog_panelLayout.createSequentialGroup()
                        .addComponent(position_label1, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, add_dialog_panelLayout.createSequentialGroup()
                        .addGroup(add_dialog_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(add_dialog_panelLayout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(position_label2, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(position_fields, javax.swing.GroupLayout.PREFERRED_SIZE, 666, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(16, 16, 16))))
        );
        add_dialog_panelLayout.setVerticalGroup(
            ...
            .addGroup(add_dialog_panelLayout.createSequentialGroup()
                ...
                .addGroup(add_dialog_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(position_label2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 21, Short.MAX_VALUE)
                .addComponent(position_label1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(employee_dropdown, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        table_employee_salary.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        table_employee_salary.setPreferredSize(null);
        jScrollPane1.setViewportView(table_employee_salary);
        ...
        add_button.setText("Add Employee Salary");
        ...
        header_name.setText("Employee Salary");
...
//           add_dialog.setModal(true);
        ...
        int row = table_employee_salary.getSelectedRow();
        if (row == -1) {
...
//        jLabel2.setText("Perbarui Data Karyawan");
        ...
        int levelId = (int) table_employee_salary.getModel().getValueAt(row, 0);
...
//        btnBatal.setVisible(false);
        ...
        table_employee_salary.getColumnModel().getColumn(0).setMinWidth(0);
        table_employee_salary.getColumnModel().getColumn(0).setMaxWidth(0);
        table_employee_salary.getColumnModel().getColumn(0).setWidth(0);
    }
    ...
    private javax.swing.JLabel position_label2;
    private javax.swing.JTable table_employee_salary;
